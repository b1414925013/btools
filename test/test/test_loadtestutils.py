...
class TestLoadTestUtils(unittest.TestCase):
    ...
    def test_simple_load_test(self):
        ...
        results = LoadTestUtils.run_load_test(
            func=test_func, concurrent_users=2, duration=1, ramp_up=0
        )
    ...
    def test_check_thresholds(self):
        """测试检查阈值"""
        results = {"success_rate": 95.0, "average_response_time": 1.5}
        thresholds = {"min_success_rate": 90.0, "max_response_time": 2.0}
