...
class DictUtil:
    ...
    @staticmethod
    def get_list(
        dictionary: Optional[Dict], key: Any, default: Optional[List] = None
    ) -> Optional[List]:
        """
        获取字典中的列表值
    ...
    @staticmethod
    def get_dict(
        dictionary: Optional[Dict], key: Any, default: Optional[Dict] = None
    ) -> Optional[Dict]:
        """
        获取字典中的字典值
    ...
    @staticmethod
    def put_if_absent(
        dictionary: Optional[Dict], key: Any, value: Any
    ) -> Optional[Dict]:
        """
        当键不存在时向字典中添加键值对
    ...
    @staticmethod
    def filter(
        dictionary: Optional[Dict], predicate: Callable[[Any, Any], bool]
    ) -> Dict:
        """
        过滤字典
    ...
    @staticmethod
    def filter_keys(
        dictionary: Optional[Dict], predicate: Callable[[Any], bool]
    ) -> Dict:
        """
        根据键过滤字典
    ...
    @staticmethod
    def map_items(
        dictionary: Optional[Dict], mapper: Callable[[Any, Any], Tuple[Any, Any]]
    ) -> Dict:
        """
        映射字典的键值对
    ...
    @staticmethod
    def from_list(
        lst: Optional[List[Dict]], key_field: str = "key", value_field: str = "value"
    ) -> Dict:
        """
        将键值对列表转换为字典
    ...
    @staticmethod
    def get_nested(
        dictionary: Optional[Dict], keys: List[Any], default: Any = None
    ) -> Any:
        """
        获取嵌套字典中的值
