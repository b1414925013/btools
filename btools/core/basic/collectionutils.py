...
class CollectionUtils:
    ...
    @staticmethod
    def find(
        collection: Union[List, Set], predicate: Callable[[Any], bool]
    ) -> Optional[Any]:
        """
        查找集合中符合条件的第一个元素
    ...
    @staticmethod
    def map(
        collection: Union[List, Set], mapper: Callable[[Any], Any]
    ) -> Union[List, Set]:
        """
        映射集合中的元素
    ...
    @staticmethod
    def max(
        collection: Union[List, Set], key: Optional[Callable[[Any], Any]] = None
    ) -> Any:
        """
        获取集合中的最大值
