...
class BeanUtils:
    ...
    @staticmethod
    def copy_properties(
        source: Any, target: Any, ignore_properties: Optional[List[str]] = None
    ) -> None:
        """
        复制对象属性
    ...
    @staticmethod
    def to_dict(
        obj: Any, ignore_properties: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """
        将对象转换为字典
    ...
    @staticmethod
    def equals(
        obj1: Any, obj2: Any, ignore_properties: Optional[List[str]] = None
    ) -> bool:
        """
        比较两个对象是否相等
