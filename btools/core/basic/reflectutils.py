...
class ReflectUtils:
    ...
    def get_functions(module) -> List[str]:
        ...
        return [
            f[0]
            for f in inspect.getmembers(module, predicate=inspect.isfunction)
    ...
    def get_classes(module) -> List[str]:
        ...
        return [
            c[0]
            for c in inspect.getmembers(module, predicate=inspect.isclass)
    ...
    @staticmethod
    def dynamic_call(
        func: callable, args: List[Any] = None, kwargs: Dict[str, Any] = None
    ) -> Any:
        """
        动态调用函数
    ...
    @staticmethod
    def create_class(
        class_name: str, bases: tuple = (object,), namespace: Dict[str, Any] = None
    ) -> Type:
        """
        动态创建类
