...
class HTTPClient:
    ...
    def __init__(
        ...
        if use_cache:
            ...
            self.session = CachedSession(cache_name=cache_name, backend=cache_backend)
        else:
    ...
    def get(
        ...
        **kwargs,
        ...
        return self.session.get(
            full_url, headers=headers, timeout=self.timeout, **kwargs
        )
    ...
    def download_file(
        ...
        **kwargs,
        ...
        response = self.session.get(
            full_url, headers=headers, timeout=self.timeout, stream=True, **kwargs
        )
