...
class MailUtils:
    ...
    def receive_email_pop3(
        ...
        try:
            ...
            for i in range(start_index, mail_total + 1):
                ...
                emails.append({"index": i, "content": msg_content})
    ...
    def receive_email_imap(
        ...
        try:
            ...
            for mail_id in recent_mail_ids:
                ...
                # 解析邮件内容
                # 这里简化处理，实际应该使用email模块解析
                emails.append({"id": mail_id.decode(), "content": msg_content})
    ...
    @staticmethod
    def create_html_email(template: str, variables: Dict[str, Any]) -> str:
        """
        创建HTML邮件
