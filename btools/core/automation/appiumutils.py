...
class AppiumUtils:
    ...
    def click_element(
        ...
        Args:
            ...
            poll_frequency (float): 轮询频率（秒）
        """
        element = AppiumUtils.wait_for_element_visible(
            driver, by, value, timeout, poll_frequency
        )
        element.click()
    ...
    def is_element_visible(
        ...
        """
        try:
            AppiumUtils.wait_for_element_visible(
                driver, by, value, timeout, poll_frequency
            )
            return True
        except Exception:
    ...
    def scroll_to_element(
        ...
        try:
            ...
            element = AppiumUtils.find_element(
                driver, by, value, timeout, poll_frequency
            )
    ...
    @staticmethod
    def swipe_up(
        driver: webdriver.Remote, duration: int = 500, percentage: float = 0.8
    ) -> None:
        """
        向上滑动
...
class AppiumElement:
    ...
    def click(self, timeout: int = 30, poll_frequency: float = 0.5) -> None:
        ...
        Args:
            ...
            poll_frequency (float): 轮询频率（秒）
        """
        AppiumUtils.click_element(
            self.driver, self.by, self.value, timeout, poll_frequency
        )
    ...
    def send_keys(
        ...
        Args:
            ...
            poll_frequency (float): 轮询频率（秒）
        """
        AppiumUtils.send_keys(
            self.driver, self.by, self.value, text, timeout, poll_frequency, clear_first
        )
    ...
    def get_text(self, timeout: int = 30, poll_frequency: float = 0.5) -> str:
        ...
        Returns:
            str: 元素文本
        """
        return AppiumUtils.get_element_text(
            self.driver, self.by, self.value, timeout, poll_frequency
        )

    def get_attribute(
        self, attribute: str, timeout: int = 30, poll_frequency: float = 0.5
    ) -> str:
        """
        获取元素属性
        ...
        Returns:
            str: 元素属性值
        """
        return AppiumUtils.get_element_attribute(
            self.driver, self.by, self.value, attribute, timeout, poll_frequency
        )
    ...
    def is_visible(self, timeout: int = 10, poll_frequency: float = 0.5) -> bool:
        ...
        Returns:
            bool: 元素是否可见
        """
        return AppiumUtils.is_element_visible(
            self.driver, self.by, self.value, timeout, poll_frequency
        )
    ...
    def is_present(self, timeout: int = 10, poll_frequency: float = 0.5) -> bool:
        ...
        Returns:
            bool: 元素是否存在
        """
        return AppiumUtils.is_element_present(
            self.driver, self.by, self.value, timeout, poll_frequency
        )
    ...
    def scroll_to(self, timeout: int = 30, poll_frequency: float = 0.5) -> None:
        ...
        Args:
            ...
            poll_frequency (float): 轮询频率（秒）
        """
        AppiumUtils.scroll_to_element(
            self.driver, self.by, self.value, timeout, poll_frequency
        )

    def long_press(
        self, duration: int = 2000, timeout: int = 30, poll_frequency: float = 0.5
    ) -> None:
        """
        长按元素
        ...
        Args:
            ...
            poll_frequency (float): 轮询频率（秒）
        """
        AppiumUtils.long_press(
            self.driver, self.by, self.value, duration, timeout, poll_frequency
        )
